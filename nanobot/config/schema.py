...
class ChannelsConfig(Base):
    ...
    transcription_provider: str = "groq"  # Voice transcription backend: "groq", "openai", or "faster_whisper"
    transcription_language: str | None = Field(default=None, pattern=r"^[a-z]{2,3}$")  # Optional ISO-639-1 hint for audio transcription
    faster_whisper: FasterWhisperConfig | None = None  # faster-whisper local STT settings
