...
if TYPE_CHECKING:
    ...
    from nanobot.agent.tools.memory_search import MemorySearchToolConfig
...
class ChannelsConfig(Base):
    ...
    transcription_provider: str | None = None  # Deprecated: use top-level transcription.provider
...
class ProvidersConfig(Base):
    ...
    umans: ProviderConfig = Field(default_factory=ProviderConfig)  # Umans AI
...
def _resolve_tool_config_refs() -> None:
    ...
    mod.MemorySearchToolConfig = MemorySearchToolConfig  # type: ignore[attr-defined]
